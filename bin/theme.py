                ...
                if m is not None:
                    ...
                    for url_regex in self.url_regexes:
                        ...
                        if m is not None:
                            ...
                            if '/++theme++unibo.api/' in m.group(1):
                                # BBB: ignora i failed_path quando si tratta
                                # di unibo.api, unibo.shelf, ..., questi sono
                                # unicamente funzionali a far funzionare il
                                # javascript per i designer...
                                pass
                            elif '/++theme++unibo.shelf/' in m.group(1):
                                pass
                            elif '/Portale/' in m.group(1):
                                pass
                            elif '/Medicina+Veterinaria/' in m.group(1):
                                pass
